...
public class ExceptionsHandler {
    ...
    @ExceptionHandler({AlreadyUsedException.class, SongAlreadyInPlaylistException.class, ClientPexelsException.class, ResCountriesException.class, LastFmException.class})
